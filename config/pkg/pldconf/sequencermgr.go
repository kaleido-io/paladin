...
var SequencerDefaults = SequencerConfig{
	...
	BlockHeightTolerance:              confutil.P(uint64(1)),
	BlockRange:                        confutil.P(uint64(1000000000)),
	ClosingGracePeriod:                confutil.P(1),
	CoordinatorEventQueueSize:         confutil.P(1000),
	CoordinatorPriorityEventQueueSize: confutil.P(5000),
	DelegationBatchInterval:           confutil.P("500ms"),
	DispatchCommitRetry:               GenericRetryDefaults.RetryConfig,
	DispatchMaxBatchSize:              confutil.P(100),
	HeartbeatInterval:                 confutil.P("5s"),
	IdleSequencerCleanupInterval:      confutil.P("24h"),
	InactiveGracePeriod:               confutil.P(2),
	MaxDispatchAhead:                  confutil.P(5000),
	MaxInflightTransactions:           confutil.P(5000),
