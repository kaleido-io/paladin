...
type EngineIntegration interface {
	...
	AssembleAndSign(ctx context.Context, transactionID uuid.UUID, preAssembly *prototk.TransactionPreAssembly, stateLocksJSON []byte, blockHeight int64) (*prototk.TransactionPostAssembly, error)
}
...
func (e *engineIntegration) AssembleAndSign(ctx context.Context, transactionID uuid.UUID, preAssembly *prototk.TransactionPreAssembly, stateLocksJSON []byte, blockHeight int64) (*prototk.TransactionPostAssembly, error) {
...
func (e *engineIntegration) assembleAndSign(ctx context.Context, transactionID uuid.UUID, preAssembly *prototk.TransactionPreAssembly, resolvedVerifiers []*prototk.ResolvedVerifier, domainContext components.DomainContext) (*prototk.TransactionPostAssembly, error) {
	...
	assemblyResponse, err := e.domainSmartContract.AssembleTransaction(domainContext, e.components.Persistence().NOTX(), transactionID, preAssembly, localTx, resolvedVerifiers)
	if err != nil {
