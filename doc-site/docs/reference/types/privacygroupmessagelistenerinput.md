---
title: PrivacyGroupMessageListenerInput
---
{% include-markdown "./_includes/privacygroupmessagelistenerinput_description.md" %}
...
| `options` | Options for the message listener | [`PrivacyGroupMessageListenerOptions`](#privacygroupmessagelisteneroptions) |
